...
class TestObject:
    @mark.asyncio
    async def test_action_chains(self, setup_functional_environment: AsyncPage):
    ...
    @mark.asyncio
    async def test_save_screenshot(self, setup_functional_environment: AsyncPage):
        driver = setup_functional_environment

        assert await driver.save_screenshot("/tmp/test.png") is True

    @mark.asyncio
    async def test_object_to_string(self, setup_functional_environment: AsyncPage):
        driver = setup_functional_environment
    ...
    @mark.asyncio
    async def test_get_computed_role(self, setup_functional_environment: AsyncPage):
        driver = setup_functional_environment
        element = await driver.find_element(locator=By.XPATH, value="//button")
        assert await element.get_computed_role() == "button"

    @mark.asyncio
    async def test_get_computed_label(self, setup_functional_environment: AsyncPage):
        driver = setup_functional_environment
        element = await driver.find_element(locator=By.XPATH, value="//button")
        assert await element.get_computed_label() == "test"

    @mark.asyncio
    async def test_get_attribute(self, setup_functional_environment: AsyncPage):
        driver = setup_functional_environment
        element = await driver.find_element(locator=By.XPATH, value="//input")
        assert await element.get_attribute(attribute="value") == ""

    @mark.asyncio
    async def test_clear(self, setup_functional_environment: AsyncPage):
        driver = setup_functional_environment
        element = await driver.find_element(locator=By.XPATH, value="//input")
        assert await element.clear() is True

    @mark.asyncio
    async def test_text_property(self, setup_functional_environment: AsyncPage):
        driver = setup_functional_environment
        element = await driver.find_element(locator=By.XPATH, value="//button")
        assert element.text == "test"

    @mark.asyncio
    async def test_send_keys(self, setup_functional_environment: AsyncPage):
        driver = setup_functional_environment
        element = await driver.find_element(locator=By.XPATH, value="//body")
        assert await element.send_keys(text="any") is True

    @mark.asyncio
    async def test_click(self, setup_functional_environment: AsyncPage):
        driver = setup_functional_environment
        element = await driver.find_element(locator=By.XPATH, value="//body")
        assert await element.click() is True

    @mark.asyncio
    async def test_find_elements_from_element(self, setup_functional_environment: AsyncPage):
        driver = setup_functional_environment
        expected = 1
        element = await driver.find_element(locator=By.XPATH, value="//body")
    ...
    @mark.asyncio
    async def test_find_element_from_element(self, setup_functional_environment: AsyncPage):
        driver = setup_functional_environment
        element = await driver.find_element(locator=By.XPATH, value="//body")
    ...
    @mark.asyncio
    async def test_find_elements(self, setup_functional_environment: AsyncPage):
        driver = setup_functional_environment
        expected = 1
    ...
    @mark.asyncio
    async def test_find_element(self, setup_functional_environment: AsyncPage):
        driver = setup_functional_environment
