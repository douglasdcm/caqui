...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_RECT)
def test_get_rect(*args: tuple) -> None:
    expected: dict = {"height": 23, "width": 183, "x": 10, "y": 9652.12}
    assert synchronous.get_rect("", "", "") == expected


@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.ACTIONS)
def test_actions_scroll_to_element(*args: tuple) -> None:
    assert synchronous.actions_scroll_to_element("", "", "") is True


@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.CLICK)
...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_TIMEOUTS)
def test_set_timeouts(*args: tuple) -> None:
    assert synchronous.set_timeouts("", "", 0) is True


@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.FIND_ELEMENTS)
...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.FIND_ELEMENT)
...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.EXECUTE_SCRIPT)
...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_PAGE_SOURCE)
def test_get_page_source(*args: tuple) -> None:
    expected: str = "Sample page"
    assert expected in synchronous.get_page_source("", "")


@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_ALERT_TEXT)
def test_get_alert_text(*args: tuple) -> None:
    expected: str = "any warn"
    assert synchronous.get_alert_text("", "") == expected


@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_ACTIVE_ELEMENT)
def test_get_active_element(*args: tuple) -> None:
    expected: str = "0.8851292311864847-1"
    assert synchronous.get_active_element("", "") == expected


@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.CLEAR_ELEMENT)
def test_clear_element(*args: tuple) -> None:
    assert synchronous.clear_element("", "", "") is True


@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.IS_ELEMENT_ENABLED)
def test_is_element_enabled(*args: tuple) -> None:
    assert synchronous.is_element_enabled("", "", "") is True


@patch(
    "caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_CSS_COLOR_VALUE
)
...
@patch(
    "caqui.webdriver.engine.synchronous.request", return_value=fake_responses.IS_ELEMENT_SELECTED
)
...
@patch(
    "caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_WINDOW_RECTANGLE
)
...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_WINDOW_HANDLES)
...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.CLOSE_WINDOW)
...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_WINDOW)
...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_URL)
...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_STATUS)
def test_get_status(*args: tuple) -> None:
    assert synchronous.get_status("").get("value", {}).get("ready", False) is True


@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_TITLE)
...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_COOKIES)
...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_PROPERTY_VALUE)
...
@patch(
    "caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_ATTRIBUTE_VALUE
)
...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GO_TO_PAGE)
def test_go_to_page(*args: tuple) -> None:
    assert synchronous.go_to_page("", "", "") is True


@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.CLOSE_SESSION)
def test_close_session(*args: tuple) -> None:
    assert synchronous.close_session("", "") is True


@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_TEXT)
...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.SEND_KEYS)
...
@patch("caqui.webdriver.engine.synchronous.request", return_value=fake_responses.GET_SESSION)
