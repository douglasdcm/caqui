...
from caqui.webdriver.engine import asynchronous
...
async def test_get_rect():
    ...
    with patch("caqui.webdriver.engine.asynchronous._get", mock_request):
...
async def test_actions_scroll_to_element():
    ...
    with patch("caqui.webdriver.engine.asynchronous._post", mock_request):
...
async def test_close_window() -> None:
    ...
    with patch("caqui.webdriver.engine.asynchronous._delete", mock_request):
