...
class Element:
    def __init__(self, element: dom.NodeId, driver: "AsyncDriverCDP") -> None:
        self._element: dom.NodeId = element
        self._conn: AsyncCDPConnection = driver.conn
        self._driver: "AsyncDriverCDP" = driver
    ...
    @property
    def element_id(self) -> dom.NodeId:
