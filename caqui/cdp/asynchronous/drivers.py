...
from caqui.cdp.asynchronous.action_chains import ActionChains
from caqui.cdp.asynchronous.alert import Alert
from caqui.cdp.asynchronous.element import Element
from caqui.cdp.asynchronous.switch_to import SwitchTo
from caqui.cdp.asynchronous.window import Window
...
class AsyncDriverCDP:
    ...
    def __init__(
        ...
        """
        self._conn = conn
        self._current_element: Union[Element, None] = None

    @property
    def conn(self) -> AsyncCDPConnection:
    ...
    async def get_window_handles(self) -> list:
